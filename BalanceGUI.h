...
namespace ATMMachineProject {
	...
	/// <summary>
	/// Summary for BalanceGUI
	/// </summary>
	public ref class BalanceGUI : public System::Windows::Forms::Form
	{
	public:
		BalanceGUI(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(BalanceGUI::typeid));
			...
			this->panel1->Location = System::Drawing::Point(42, 60);
			...
			this->label4->Size = System::Drawing::Size(154, 15);
			this->label4->TabIndex = 4;
			this->label4->Text = L"You have a balance of";
			// 
			// label2
			// 
			...
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Consolas", 21.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox1->Location = System::Drawing::Point(153, 123);
			this->textBox1->Name = L"textBox1";
			this->textBox1->ReadOnly = true;
			this->textBox1->Size = System::Drawing::Size(207, 41);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Consolas", 21.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(116, 125);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(31, 34);
			...
			this->withdrawbutton1->Text = L"Confirm";
			this->withdrawbutton1->UseVisualStyleBackColor = false;
			this->withdrawbutton1->Click += gcnew System::EventHandler(this, &BalanceGUI::withdrawbutton1_Click);
			// 
			// label1
			// 
			...
			this->Name = L"BalanceGUI";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Balance";
			this->Load += gcnew System::EventHandler(this, &BalanceGUI::BalanceGUI_Load);
...
private: System::Void BalanceGUI_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		if (dataRead2->Read())
			textBox1->Text = dataRead2->GetDouble("balance").ToString();
		else
